/* V68: cập nhật nội dung bài viết tĩnh trực tiếp từ Supabase.
...
function linkifyArticleContentStatic(html){
  ...
  function render(root,a,list){
    ...
    const content=linkifyArticleContentStatic(stripLeading(a.content,a.title,a.seoTitle));
