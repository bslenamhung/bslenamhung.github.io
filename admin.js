...
function openArticleEditor(index=-1){
  ...
  const a=index>=0?D.articles[index]:{title:"",slug:"",slug:"",specialty:D.specialties[0]?.name||"Sản khoa",desc:"",image:"",content:"",videoUrl:"",published:false,seoTitle:"",seoDescription:"",keywords:"",seoImage:""};
